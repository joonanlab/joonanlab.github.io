...
AnnQ was developed to capture these ambiguous moments. AnnQ takes the reference-based annotation probabilities and asks how stable the cell identity is and how far the cell appears to move away from the reference. It classifies cells into uncertainty states such as G0, G1, G2, and G3, while also estimating out-of-reference scores. AnnQ can reveal subtle lineage-level shifts even when no clearly separated new cluster appears.
