        ...
        <div>
          ...
          <ScrollReveal>
            <div className="card mb-6">
              <h3 className="text-2xl font-bold mb-2" style={{ color: 'var(--accent)' }}>
          ...
          <ScrollReveal delay={0.2}>
            <div className="card mb-6 ko-only">
              <h3 className="text-2xl font-bold mb-2" style={{ color: 'var(--accent-gold)' }}>
          ...
          <ScrollReveal delay={0.2}>
            <div className="card mb-6 ko-only">
              ...
              <div className="space-y-4 mt-4">
                <div>
                  <h4 className="font-semibold text-base mb-1" style={{ color: 'var(--text-primary)' }}>인공지능을 활용한 전장유전체 유전변이분석</h4>
                ...
                <div>
                  <h4 className="font-semibold text-base mb-1" style={{ color: 'var(--text-primary)' }}>약물 유전체 연구를 위한 유전변이 분석 기초 및 실습</h4>
                ...
                <div>
                  <h4 className="font-semibold text-base mb-1" style={{ color: 'var(--text-primary)' }}>전장유전체 변이 분석의 이해</h4>
          ...
          <ScrollReveal delay={0.2}>
            <div className="ko-only mt-8">
              <h3 className="text-2xl font-bold mb-6" style={{ color: 'var(--accent-gold)' }}>
                공개 강의 모음
              </h3>
              <div className="space-y-8">
                <div className="card">
                  <h4 className="font-semibold mb-2" style={{ color: 'var(--text-primary)' }}>[3rd 오티즘스쿨] &quot;자폐의 유전자 연구: 유전자 연구란 무엇인가?&quot;</h4>
                ...
                <div className="card">
                  <h4 className="font-semibold mb-2" style={{ color: 'var(--text-primary)' }}>DNA를 통해 본 여성의 자폐 (제 19회 경암바이오유스캠프)</h4>
                ...
                <div className="card">
                  <h4 className="font-semibold mb-2" style={{ color: 'var(--text-primary)' }}>고려대학교의 클라우드를 활용한 유전체 분석 연구의 혁신 사례</h4>
